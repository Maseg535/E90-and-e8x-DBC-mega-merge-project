...
# Known example byte values per message ID — auto-generated from HIL logs
# Most common observed value per byte position. Regenerate with tools/extract_known_values.py
$knownValues = @{
    130 = @(0x45, 0x40, 0x21, 0x8F, 0xF2)
    135 = @(0xF5, 0xFF)
    175 = @(0x03, 0x00, 0x0C)
    200 = @(0x2C, 0x91, 0xFC, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF)
    202 = @(0x7E, 0xFF)
    226 = @(0x00, 0xFE, 0xFF, 0x4F, 0xF3)
    228 = @(0x00, 0x00)
    242 = @(0x01, 0xF1, 0xFD, 0xFF, 0xFF)
    246 = @(0x3F, 0xF3, 0x64, 0xFD, 0xFF)
    252 = @(0xCD, 0xFF)
    264 = @(0xE1, 0xFD, 0xFA, 0x00, 0x80, 0x1E)
    267 = @(0xE1, 0xFD, 0x48, 0x00, 0xC0, 0x01)
    273 = @(0x1D, 0xE1, 0x00, 0xF0, 0xFF, 0x7F, 0xDE, 0x01)
    277 = @(0xE1, 0x9D, 0x03, 0xFF)
    278 = @(0x0A, 0x15, 0x01, 0x0F, 0x00, 0x14, 0x2E, 0xE6)
    286 = @(0x00, 0xFF)
    304 = @(0xE3, 0xFF)
    306 = @(0x00, 0xF0)
    311 = @(0x00, 0xF0)
    ...
    314 = @(0x11, 0x00, 0xFF)
    316 = @(0xFD, 0xFF)
    328 = @(0xAF, 0xEC, 0x10, 0x00, 0x6E, 0x25)
    330 = @(0xCD, 0x3B, 0x04, 0x20, 0x00, 0x3B, 0x2C, 0x12)
    335 = @(0x00, 0x48, 0x58, 0x2C, 0x33, 0x91, 0xAA, 0x42)
    336 = @(0x00, 0x00, 0x00, 0xFE, 0xFF, 0xFE, 0xFF)
    339 = @(0xCF, 0x00)
    341 = @(0xD0, 0x04)
    348 = @(0xFE, 0xFE, 0xFE, 0xFE, 0xFE, 0x70, 0x86, 0x00)
    349 = @(0xFE, 0x01, 0x7E, 0x16, 0x00)
    360 = @(0xFD, 0xFD, 0xFF, 0xFD, 0xDF, 0xFD, 0xFF)
    362 = @(0x93, 0xD0, 0x09, 0x98, 0xA0, 0x08, 0xE5)
    364 = @(0xFD, 0xFD, 0xFF, 0xFD, 0xDF, 0xFD, 0xFF)
    366 = @(0x6B, 0x70, 0x12, 0xFC)
    367 = @(0x17, 0x03, 0x00, 0x80, 0x1B, 0xF8, 0xD0)
    380 = @(0x45, 0x37, 0x32, 0x35, 0x34, 0x32, 0x37)
    388 = @(0x08, 0x01, 0x64, 0x16, 0xE2, 0x01, 0x14)
    394 = @(0x44, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF)
    395 = @(0x03, 0x08, 0x50, 0x64, 0xFF)
    410 = @(0x1B, 0x03, 0xEA, 0x07)
    411 = @(0x17, 0x22, 0x0C)
    413 = @(0x17, 0x8E, 0x97, 0x86, 0x01, 0x77, 0xE9, 0x87)
    415 = @(0x47, 0xE7, 0x80, 0xB6, 0xF1, 0x00, 0x80)
    480 = @(0x01, 0x42, 0xFE, 0x01, 0xFF, 0xFF, 0xFF, 0xFF)
    481 = @(0x40, 0x42, 0xFF, 0x01, 0xFF, 0xFF, 0xFF, 0xFF)
    580 = @(0x6E, 0x05, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF)
    581 = @(0x40, 0x4D, 0x00, 0x29, 0xFF, 0xFF, 0xFF, 0xFF)
    592 = @(0x80, 0x01, 0x00, 0x10, 0x1B, 0xF8, 0x18, 0xFF)
    598 = @(0x40, 0xFA, 0x00, 0x14, 0xFF, 0xFF, 0xFF, 0xFF)
    601 = @(0xF0, 0x02, 0x58, 0x00, 0x00, 0x00, 0x00, 0x00)
    640 = @(0xF0, 0x30, 0x00, 0x02, 0xFF, 0xFF, 0xFF, 0xFF)
    656 = @(0xF0, 0x03, 0x7F, 0x18, 0x78, 0x00, 0x00, 0x00)
    660 = @(0xF0, 0x21, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00)
    662 = @(0xF0, 0x02, 0x58, 0x00, 0xFF, 0xFF, 0xFF, 0xFF)
    663 = @(0xF0, 0x03, 0x7F, 0x18, 0x78, 0xFF, 0xFF, 0xFF)
    667 = @(0xF0, 0x02, 0x58, 0x00, 0xFF, 0xFF, 0xFF, 0xFF)
    672 = @(0xF1, 0x21, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF)
    673 = @(0xF0, 0x02, 0x58, 0x00, 0xFF, 0xFF, 0xFF, 0xFF)
    678 = @(0xF0, 0x02, 0x58, 0x00, 0xFF, 0xFF, 0xFF, 0xFF)
    692 = @(0xF0, 0x02, 0x58, 0x00, 0xFF, 0xFF, 0xFF, 0xFF)
}
